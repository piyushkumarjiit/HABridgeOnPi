...
then
	...
	haBridgeLink='https://github.com/bwssytems/ha-bridge/releases/download/v5.4.1RC1/ha-bridge-5.4.1RC1.jar'
	...
	haBridgeLink='https://github.com/bwssytems/ha-bridge/releases/download/v5.4.1RC1/ha-bridge-5.4.1RC1-java11.jar'
fi
...
echo "HA Bridge script complete. Wait few minutes and then ask Alexa to search for new devices."
